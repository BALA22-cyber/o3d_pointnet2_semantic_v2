...
class SemanticDataset:
    def __init__(
        ...
        self.path = path
        self.labels_names = [
            "unlabeled",                #0: [255, 255, 255],  # white
            "man-made terrain",         #1: [0, 0, 255],  # blue
            "natural terrain",          #2: [128, 0, 0],  # maroon
            "high vegetation",          # 3: [255, 0, 255],  # fuchisia
            "low vegetation",           #4: [0, 128, 0],  # green
            "buildings",                # 5: [255, 0, 0],  # red
            "hard scape",               # 6: [128, 0, 128],  # purple
            "scanning artifact",        # 7: [0, 0, 128],  # navy
        "cars",                         #  8: [128, 128, 0],  # olive
        ] 
